...
for i in range(0,len(Nsc_array)):
    ...
    z1_ = zfull.z1()
    plt.plot(Cfull,z1_,'k',alpha = alpha0-0.75/len(Nsc_array)*i )
plt.xlabel('$C/\sqrt{N}$')
...
plt.ylim(-0.1,2.1)
plt.text(1.0,1.5,'Fully Stretched DB',fontsize=15,ha='center', va='center',color='r')
plt.text(1.5,1.0,'LB',fontsize=15,ha='center', va='center',color='r')
plt.text(0.3,0.3,'DB',fontsize=15,ha='center', va='center',color='r')
plt.text(1.5,0.0,'DC',fontsize=15,ha='center', va='center',color='r')
plt.arrow(1.75,0.85,0,-0.7,head_width=0.05,head_length=0.15,length_includes_head=True,color = 'b')
plt.text(1.85,0.68,'$N_{sc}$',fontsize=15,ha='center', va='center',color='b')
