...
# -*- coding: utf-8 -*-
"""
Created on Mon Jun  1 16:03:56 2020
...
class Input_Builder_Seed():
    def __init__(self, f, inputfileversion, nummodel, modeltype, n_species, \
        ...
        :param modeltype:
        :param n_species:
        :param kuhn_length_text:
        :param chain_label:
        :param n_sidearm_types:
        :param models_add:
        :param chain_text_list:
        :param chiN_list:
        :param interation_add:
        :param d:
        :param initial_box:
        :param npw:
        ...
        :param field_updater:
        :param cell_updater:
        :param timesteps_block:
        :param block_num:
        :param dt:
        :param force_scale_text:
        :param stress_scale:
        :param force_tol:
        :param stress_tol:
        :param variablecell_bool:
        :param density_history_bool:
        :param field_history_bool:
        :param density_chain_bool:
        :param format_fields_bool:
        :param volfrac_chain:
        :param cellscale:
        :param add_phase:
        :param space_group:
        :param non_primitive_centering:
        :param symmetrize:
        :param parallel_cuda:
        :param cuda_thread_block_size:
        :param nThreads:
        """
