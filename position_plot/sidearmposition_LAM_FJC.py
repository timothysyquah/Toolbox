...
path = '/home/tquah/Projects/positions/sidearmposition/FJC/highchicomp/Test_1/density_chain0.dat'
...
path = '/home/tquah/Projects/positions/sidearmposition/FJC/highchicomp/Side_1/density_chain0.dat'
data = np.loadtxt(path)
shape = np.shape(data)
count = 0
color = ['b','b','b']
...
path = '/home/tquah/Projects/positions/sidearmposition/FJC/highchicomp/Test_linear_1/density_chain0.dat'
...
plt.tight_layout()
plt.savefig('/home/tquah/Figures/10-16-2020-GFKD-Meeting/strong_compare_chaindensity_FJC.png')

path = '/home/tquah/Projects/positions/sidearmposition/FJC/highchicomp/Test_linear_1/density.dat'
data = np.loadtxt(path)
...
path = '/home/tquah/Projects/positions/sidearmposition/FJC/highchicomp/Test_1/density.dat'
data = np.loadtxt(path)
...
for i in range(1,shape[1]):
    ...
    y = cs(x)/integral
    if i==1:
        plt.plot(x,y,'b',label = 'Bottlebrush')
    else:
        plt.plot(x,y,'b')
