...
path = '/media/tquah/TOSHIBA EXT/Projects/positions/sidearmposition/DGC/lowchicomp/Test_1/density_chain0.dat'
...
path = '/media/tquah/TOSHIBA EXT/Projects/positions/sidearmposition/DGC/lowchicomp/Side_1/density_chain0.dat'
data = np.loadtxt(path)
shape = np.shape(data)
count = 0
color = ['b','b','b']
...
path = '/home/tquah/Projects/positions/sidearmposition/DGC/lowchicomp/Test_linear_1/density_chain0.dat'
...
plt.tight_layout()
plt.savefig('/home/tquah/Figures/10-16-2020-GFKD-Meeting/weak_compare_chaindensity_DGC.png')

path = '/home/tquah/Projects/positions/sidearmposition/DGC/lowchicomp/Test_linear_1/density.dat'
data = np.loadtxt(path)
...
path = '/home/tquah/Projects/positions/sidearmposition/DGC/lowchicomp/Test_1/density.dat'
data = np.loadtxt(path)
