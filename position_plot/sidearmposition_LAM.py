...
path = '/home/tquah/Projects/positions/highchicomp/Test_1/density_chain0.dat'
...
path = '/home/tquah/Projects/positions/highchicomp/Side_1/density_chain0.dat'
data = np.loadtxt(path)
shape = np.shape(data)
count = 0
color = ['b','b','b']
...
path = '/home/tquah/Projects/positions/highchicomp/Test_linear_1/density_chain0.dat'
...
path = '/home/tquah/Projects/positions/highchicomp/Test_linear_1/density.dat'
data = np.loadtxt(path)
...
path = '/home/tquah/Projects/positions/highchicomp/Test_1/density.dat'
data = np.loadtxt(path)
