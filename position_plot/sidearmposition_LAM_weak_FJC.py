...
path = '/home/tquah/Projects/positions/sidearmposition/FJC/lowchicomp/Test_1/density_chain0.dat'
...
path = '/home/tquah/Projects/positions/sidearmposition/FJC/lowchicomp/Side_1/density_chain0.dat'
data = np.loadtxt(path)
shape = np.shape(data)
count = 0
color = ['b','b','b']
...
for i in range(shape[1],1,-1):
    ...
    if i in desired_list:
        ...
        if count==0:
            oreloc = np.where(data[:,i]==np.max(data[:,i]))[0][0]
        print(data[oreloc,0]/np.max(data[:,0]))
...
path = '/home/tquah/Projects/positions/sidearmposition/FJC/lowchicomp/Test_linear_1/density_chain0.dat'
...
plt.tight_layout()
plt.savefig('/home/tquah/Figures/10-16-2020-GFKD-Meeting/weak_compare_chaindensity_FJC.png')

path = '/home/tquah/Projects/positions/sidearmposition/FJC/lowchicomp/Test_linear_1/density.dat'
data = np.loadtxt(path)
...
path = '/home/tquah/Projects/positions/sidearmposition/FJC/lowchicomp/Test_1/density.dat'
data = np.loadtxt(path)
