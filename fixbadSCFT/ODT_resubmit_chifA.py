...
# print(os.listdir())
os.chdir("/home/tquah/Projects/sweep-asym-armlength_BCC_fix/")
dirs = glob.glob("/home/tquah/Projects/sweep-asym-armlength_BCC_fix/chiAB_*/Nsc*/fA*")
phaselist = ['HEX']
...
for Phase in phaselist:
    ...
    for i in chi:
        for j in ratio:
            ...
            # print(fA_seed)
            dec = len(str(i))-2
            partialpath = f'chiAB_{i:0.{dec}f}/NscA_{j[0]:0.1f}_NscB_{j[1]:0.1f}/fA{fA_seed[0]:0.5f}'
    ...
    for i in chi:
        for j in ratio:
            ...
            op.write(f'{store_dict_low[i,j][-2]} {store_dict_low[i,j][-1]} {Phase} \n')
    op.close()
