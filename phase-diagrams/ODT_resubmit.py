    ...
    for i in chi:
        for j in ratio:
            ...
            if f'{Phase}Phase' in phase and 'DISPhase' in phase:
                ...
                print(f'No High {Phase}@chiN = {i},NscA_{j[0]}_NscB_{j[1]}')
            ...
            store_dict_high[i,j][-1] = partialpath
            ...
            if f'{Phase}Phase' in phase and 'DISPhase' in phase:
                ...
                print(f'No Low {Phase}@chiN = {i},NscA_{j[0]}_NscB_{j[1]}')
            ...
            store_dict_low[i,j][-1] = partialpath
    
    exportpath = os.path.join(pwd,f'ODT/{Phase}.dat')
