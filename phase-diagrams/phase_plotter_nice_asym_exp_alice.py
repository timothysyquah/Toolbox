...
path_exp = '/media/tquah/TOSHIBA EXT/Projects/PhaseDiagram/Experimental_Dataset_v2_alice.csv'
...
for phase in phases:
    ...
    loc = np.where(df['Phase'].str.find(phase)==0)[0]  
    plt.scatter(fA[loc],ab_ratio[loc],c = 'r',marker = symbol[i],zorder = 1)
    
    
    # j=0
    # for l in Nsc_Backbone[loc]:
    #     if l>1:
    #         plt.scatter(fA[loc[j]],ab_ratio[loc[j]],c = 'k',alpha = 0.5,s = 300.0,zorder = 2)
    #     j+=1
    i+=1
...
textsize = 20
plt.text(0.57,1.7,'L',color = 'k',size = textsize,ha = 'center')
plt.text(0.5,2.5,'G',color = 'k',size = textsize,ha = 'center')
plt.text(0.57,1.6,'G',color = 'k',size = textsize,ha = 'center')
plt.text(0.81,1.7,'C',color = 'k',size = textsize,ha = 'center')
plt.text(0.87,1.7,'S',color = 'k',size = textsize,ha = 'center')

# plt.arrow(0.37,2.05,.025,0,color = 'k',head_length=0.01,width = 0.05)
# plt.text(0.2,3.8,'A15',color = 'k',size = textsize)
plt.text(0.295,3.5,'A15',color = 'k',size = textsize,ha = 'center')
plt.text(0.198,1.7,'$\sigma$',color = 'k',size = textsize,ha = 'center')

plt.text(0.3,1.7,'C',color = 'k',size = textsize,ha = 'center')
plt.text(0.155,1.7,'S',color = 'k',size = textsize,ha = 'center')
plt.text(0.07,1.7,'D',color = 'k',size = textsize,ha = 'center')
plt.text(0.95,1.7,'D',color = 'k',size = textsize,ha = 'center')
...
plt.savefig('/home/tquah/Figures/10-23-2020-GFKD-Meeting/asymexp_phasediagram_alice.png',dpi=300)
